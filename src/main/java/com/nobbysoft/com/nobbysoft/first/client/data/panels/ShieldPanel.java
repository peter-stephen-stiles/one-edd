...
import com.nobbysoft.com.nobbysoft.first.client.components.special.PComboBulk;
...
public class ShieldPanel extends AbstractDataPanel<Shield, String> implements MaintenancePanelInterface<Shield> {
	...
	void populateFromScreen(Shield value, boolean includingKeys) {
		if (includingKeys) {
	...
	void populateScreen(Shield value) {
