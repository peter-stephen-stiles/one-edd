...
import com.nobbysoft.first.client.data.DataFrame;
import com.nobbysoft.first.client.data.SqlFrame;
import com.nobbysoft.first.common.constants.Constants;
import com.nobbysoft.first.server.db.StartNetworkServer;
...
public class SqlMain {
    ...
    private SqlMain() throws SQLException{
    	SqlFrame df = new SqlFrame();
